                    ...
                    <div className={classes.padded}>
                        <div id='startup-list'>
                            <div className='row mx-3 align-items-center justify-content-between'>
                                <div className='col-4'>
                                    <h5 className='fw-bold m-0'>Hire Employees</h5>
                                </div>
                                <div className="col-5 input-group shadow-sm h-100 p-0" style={{ overflow: 'hidden', borderColor: 'rgb(18, 24, 39)' }}>
                                    <input style={{ border: '0px' }} type="text" className="form-control bg-white" placeholder="Search Employees" aria-label="Recipient's username" aria-describedby="button-addon2" />
                                ...
                                <div className="shadow-sm card cardColorPinkish rounded m-3" style={{ width: '18rem', border: '0px' }}>
                                    <div className="card-body">
                                        ...
                                        <div className='d-flex align-items-center justify-content-between'>
                                            ...
                                            <Button style={{ textTransform: 'capitalize' }} size='small' variant='contained' color="primary">Hire</Button>
