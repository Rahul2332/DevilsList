            ...
            <div className={classes.root}>
                ...
                >
                    ...
                    <List className="mx-auto" style={{ width: '90%' }}>
                        ...
                        <Link to="/dashboard-employee" style={{ color: "inherit", textDecoration: 'unset' }}>
                            <ListItem
                                className={(currentLocation === "/dashboard-employee" ? "highlight-karo" : "")}
                                style={{ marginBottom: '10px' }} button key='Dashboard'>
                                <HomeRoundedIcon className={(currentLocation === "/dashboard-employee" ? "green-karo" : "") + " menu-icon-color"} />
                                {/* <ListItemText className="ms-2" primary='Dashboard'/> */}
                                <span className={(currentLocation === "/dashboard-employee" ? "green-karo" : "") + " font13 fw-bold ms-2 menu-item-color"}>Dashboard</span>
                            </ListItem>
                        </Link>

                        <Link to="/employee-requests-company" style={{ color: "inherit", textDecoration: 'unset' }}>
                            <ListItem
                                className={(currentLocation === "/employee-requests-company" ? "highlight-karo" : "")}
                                style={{ marginBottom: '10px' }} button key='Startups List'>
                                <SearchIcon className={(currentLocation === "/employee-requests-company" ? "green-karo" : "") + " menu-icon-color"} />
                                {/* <ListItemText className="ms-2" primary='Dashboard'/> */}
                                <span className={(currentLocation === "/employee-requests-company" ? "green-karo" : "") + " font13 fw-bold ms-2 menu-item-color"}>Search for Job</span>
                            </ListItem>
                        </Link>
