      ...
      <PDFViewer style={styles.viewer}>
        ...
        <Document>
          ...
          EFFECTIVE REGISTRATION STATEMENT OR AN EXEMPTION THEREFROM.  
            ...
            <Text style={styles.text}>
              THIS CERTIFIES THAT in exchange for the payment by {details["investorName"]} (the “Investor”) of {details["investement"]} (the “Purchase Amount”) on or about 12/08/22, {details["companyName"]}, a Rajasthan corporation (the “Company”), issues to the Investor the right to certain shares of the Company’s Capital Stock, subject to the terms described below.
            </Text>
            <Text style={styles.text}>
            ...
            <Text style={styles.text}>
              The “Post-Money Valuation Cap” is {details["valuationCap"]} xtz.  See Section 2 for certain additional defined terms.
            </Text>
            <Text style={styles.text}>
              1. Events
            </Text>
