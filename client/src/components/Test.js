...
export const Test = () => {
  const a = "Anurag Singh Naruka"
    return (
        // <></>
        <PDFViewer style={styles.viewer}>
      <Document>
      <Page style={styles.body} wrap>
        <Text style={styles.title}>INDEMNIFICATION AGREEMENT</Text>
        ...
        THIS INDEMNIFICATION AGREEMENT (the “Agreement”) is made and entered into as of [___________ (Date)] between Friska.Corp , a Delaware corporation (the “Company”), and Rakshit Bang (“Indemnitee”).
