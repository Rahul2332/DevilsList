        ...
        <main className={classes.content}>
          ...
          <div className={classes.padded}>
            ...
            <div className='d-flex justify-content-between mb-5'>
              <div className="shadow cardColorPinkish rounded p-3 d-flex align-items-center" style={{ width: '18rem', border: '0px' }}>
                <PeopleAltRoundedIcon style={{ fontSize: '50px', color: 'linear-gradient(90deg, #4776E6 0%, #8E54E9 100%)' }} className='w-25 color-chat-request me-3' />
                <div className='w-75'>
                  <p className='mb-1'>Employees Appointed</p>
                  <h5 className='mb-0'>8.02K</h5>
                </div>

              </div>

              <div className="shadow cardColorPinkish rounded p-3 d-flex align-items-center" style={{ width: '18rem', border: '0px' }}>
                <AccountBalanceWalletRoundedIcon style={{ fontSize: '50px', color: 'linear-gradient(90deg, #4776E6 0%, #8E54E9 100%)' }} className='w-25 color-chat-request me-3' />
                <div className='w-75'>
                  <p className='mb-1'>Company Valuation</p>
                  <h5 className='mb-0'>1300 ꜩ</h5>
                </div>

              </div>

              <div className="shadow cardColorPinkish rounded p-3 d-flex align-items-center" style={{ width: '18rem', border: '0px' }}>
                <TrendingUpRoundedIcon style={{ fontSize: '50px', color: 'linear-gradient(90deg, #4776E6 0%, #8E54E9 100%)' }} className='w-25 color-chat-request me-3' />
                <div className='w-75'>
                  <p className='mb-1'>Stock Price</p>
                  <h5 className='mb-0'>9 ꜩ</h5>
                </div>
            ...
            <div className='d-flex align-items-center mb-4'>
              ...
              <div className='bg-white rounded15 ms-3' style={{ width: '50%', cursor: 'pointer' }}>
